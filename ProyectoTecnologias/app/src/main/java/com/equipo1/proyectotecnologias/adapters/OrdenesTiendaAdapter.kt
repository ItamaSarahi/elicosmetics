...
class OrdenesTiendaAdapter (val context: Activity, val orders: ArrayList<Order>): RecyclerView.Adapter<OrdenesTiendaAdapter.OrdersViewHolder>() {
    ...
    private fun goToOrderDetail(order: Order) {
        val i = Intent(context, DetalleOrdenesTiendaActivity::class.java)
