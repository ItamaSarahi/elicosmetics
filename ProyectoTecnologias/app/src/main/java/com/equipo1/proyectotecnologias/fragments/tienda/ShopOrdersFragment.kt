...
class ShopOrdersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myView = inflater.inflate(R.layout.fragment_tienda_orders, container, false)
        ...
        val adapter = ShopTabsPagerAdapter(requireActivity().supportFragmentManager, lifecycle, numberOfTabs)
